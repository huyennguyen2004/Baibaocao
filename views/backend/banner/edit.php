      ...
      <div class="content-wrapper">
         <section class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-12">
                     <h1 class="d-inline">Cập nhật xu hướng</h1>
                  </div>
               </div>
            </div>
         </section>
               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="mb-3">
                           <label>Slug</label>
                           <input type="text" value ="<?=$banner->link;?>" name="slug" class="form-control">
                        </div>
                        <div class="mb-3">
                           <label>Vị trí</label>
                           <textarea name="description" class="form-control"><?=$banner->position;?></textarea> 
                        </div>
                        <div class="mb-3">
