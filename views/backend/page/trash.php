                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <div class="function_style">|
                                       <a href="index.php?option=page&cat=restore&id=<?=$items->id;?>">
                                       <i class="fas fa-window-restore"></i> Khôi phục </a> |
                                       <a href="index.php?option=page&cat=destroy&id=<?=$items->id;?>" class="text-danger">
