  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 pt-4">
        ...
        <p class="pt-1">
          Copyright@ 2024 ChillShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
          mong muốn đem đến chất lượng tốt nhất cho khách hàng.
        </p>
        <p class="pt-1">
          Địa chỉ: Phường Tam Bình,thành phố Thủ Đức,thành phố Hồ Chí Minh
        </p>
        <p class="pt-1">
          Điện thoại: 012 345 6789(call, zalo) - Email: huyennguyen2004@gmail.com
        </p>
