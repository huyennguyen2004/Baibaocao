         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" name="name" id="name" value="<?=$custome->name;?>" class="form-control" placeholder="Nhập họ tên">
               </div>
               <div class="mb-3">
                  <label for="phone">Điện thoại</label>
                  <input type="text" name="phone" id="phone" value="<?=$custome->phone;?>" class="form-control" placeholder="Nhập điện thoại">
               </div>
               <div class="mb-3">
                  <label for="email">Email</label>
                  <input type="text" name="mail" id="phone" value="<?=$custome->email;?>" class="form-control" placeholder="Nhập điện thoại">
               </div>
               <div class="card">
